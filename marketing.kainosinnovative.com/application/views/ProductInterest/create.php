    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <?php endif; ?>
         ...
         <!-- /.box-header -->
		  <div class="box">
          <form role="form" action="<?php base_url('ProductInterest/create') ?>" method="post" id="idOfForm" enctype="multipart/form-data">
              <div class="box-body">
			 ...
			 <label for="active" style="color:#0c0c0c;">Active</label>
			 </div>
		 <div class="column" style='margin-left:3%;'>
			...
			<div class="column" >
                  <input class="form-control" style='height:130px;width:200px;border-radius:30px;' rows="4" cols="100" name="notes" id="notes"/>
                 </div>
				 ...
				 <div class="column">
				  ...
				  <div class="column" style="width: 9.8%;">
			 <label for="active" style="color:#0c0c0c;">Created Date <span style="color:red;"> *</span></label>
			 </div>
		 <div class="column">
                 <?php
                 $fromdate = date('Y-m-d');
                 ?>
				<input type="date" value="<?php echo $fromdate;  ?>" required name="contactCreatedate" id="contactCreatedate" class="form-control" oninvalid="this.setCustomValidity('Enter the Created date')" oninput="this.setCustomValidity('')"style="margin-left:15px;width:178px;border-radius:5px;">
