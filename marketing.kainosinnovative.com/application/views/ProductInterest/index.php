...
<!-- /.content-wrapper -->
 ...
 <form role="form" action="<?php base_url('products/index') ?>" method="post">
	...
	<div class="row">
				...
				<div class="column">
				<select id="orgname" required="" name="orgname" oninvalid="this.setCustomValidity('Enter the customer name')" oninput="this.setCustomValidity('')" class="form-control" style="width:220px;margin-left:-50%;border-radius:5px;">
				<?php if($user_data3): ?>   
        ...
        if ($user_data1): 
           ...
           ?>" required name="contactCreatedate" oninvalid="this.setCustomValidity('Enter the created date')" id="contactCreatedate" class="form-control" style="margin-left: -18px;width:170px;border-radius:5px;">
			...
			<div class="column" >
                  <input class="form-control" style='height:130px;width:245px;border-radius:30px;' rows="4" cols="100" name="notes" id="notes"value="<?php echo $notes ?>"/>
                 </div>
				 </div>
