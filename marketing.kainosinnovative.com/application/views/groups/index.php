  ...
  <div class="content-wrapper">
    ...
    <!-- </div> -->
      ...
      <?php if(in_array('createUser', $user_permission)): ?>
            <a href="<?php echo base_url('groups/create') ?>"  ><i class="fa fa-plus"></i>  Add Call Log</a>
            <br /> <br />
          <?php endif; ?>
      </div>
    </section>
...
<div class="row">
  <div class="col-sm-6">
    ...
    <label class="col-sm-4"  for="exampleInputPassword1">User </label>
    <input readonly="readonly" type="text" class="col-sm-8 form-control" style="border-radius:5px;" id="Lastupdby" name="Lastupdby" value="<?php echo $_SESSION['username']?>" autocomplete="off">
  </div>
</div>
  <div class="col-sm-6">
...
<div class="row">
  ...
  <?php if($user_data): ?>
    <div class="form-group form-inline">
                     ...
                     <!-- <label class="col-sm-2" style="/* text-align:center */" for="exampleInputPassword1"></label> -->
    <label class="col-sm-4"  for="exampleInputPassword1">Customer<span style="color:red;">*</span> </label>
    
    <select type="text" required="" oninvalid="this.setCustomValidity('Enter the Customer Name')" oninput="this.setCustomValidity('')" class="col-sm-5 heightfieldcls" style="border-radius:5px;" id="Name" name="Name" autocomplete="off">
  ...
  <div class="form-group form-inline">
                     ...
                     <!-- <label class="col-sm-2" style="/* text-align:center */" for="exampleInputPassword1"></label> -->
    <label class="col-sm-4"  for="exampleInputPassword1">Log Date <span style="color:red;">*</span></label>
	...
	<?php if($calllog_data1):?>
				...
				<?php foreach ($calllog_data1 as $k => $v): ?>
				  ...
				  <input readonly="readonly" type="date" class=" col-sm-8 form-control" required oninvalid="this.setCustomValidity('Enter the Log Date')" oninput="this.setCustomValidity('')" style="border-radius:5px;" id="datevisit" name="datevisit" 
				  value= "<?php echo strftime('%Y-%m-%d',  strtotime($v['call_Date'])) ?>" >
				<?php endforeach ?>	
			<?php endif; ?>
			<?php if(!$calllog_data1):?>
			<input readonly="readonly" type="date" class="col-sm-8 form-control" style="border-radius:5px;" id="datevisit" name="datevisit" >
			<?php endif;?>
  ...
  <div class="col-sm-6">
    <div class="form-group form-inline">
                     ...
                     <!-- <label class="col-sm-2" style="/* text-align:center */" for="exampleInputPassword1"></label> -->
    <label class="col-sm-4"  for="exampleInputPassword1">Contact Name<span style="color:red;">*</span> </label>
    
				
				
				<select type="text" required=""  class="col-sm-5 heightfieldcls" style="border-radius:5px;" oninvalid="this.setCustomValidity('Select the Contact Name')" oninput="this.setCustomValidity('')"  id="CName" name="CName" >
				  <?php if($calllog_data1):?>
				 <?php foreach ($calllog_data1 as $k1 => $v1): ?>
  ...
  <label class="mobcont" style="text-align:left">&nbsp;&nbsp;&nbsp;&nbsp;Products Interested In </label>
  ...
  <?php 
             ...
             ?>            
                     ...
                     <!-- <label class="col-sm-2" style="/* text-align:center */" for="exampleInputPassword1"></label> -->
    <label class="col-sm-4 webcont "  for="exampleInputPassword1">Products Interested In </label>
...
<div class="row">
  <div class="col-sm-6">
    ...
    <div class="form-group form-inline">
                     ...
                     <!-- <label class="col-sm-2" style="/* text-align:center */" for="exampleInputPassword1"></label> -->
    <label class="col-sm-4"  for="exampleInputPassword1">Mode<span style="color:red;">*</span> </label>
    
    
				
				
				<select type="text" required="" oninvalid="this.setCustomValidity('Select the Call Mode')" oninput="this.setCustomValidity('')" class="col-sm-8 form-control modefieldcls" style="border-radius:5px;" id="mode" name="mode"  autocomplete="off" ">
				   <?php if($calllog_data1):?>
				 <?php foreach ($calllog_data1 as $k1 => $v1): ?>
...
<div class="row">
  <div class="col-sm-6">
    ...
    <div class="form-group form-inline">
                     ...
                     <!-- <label class="col-sm-2" style="/* text-align:center */" for="exampleInputPassword1"></label> -->
    <label class="col-sm-4"  for="exampleInputPassword1">Call Type<span style="color:red;">*</span> </label>
				...
				<select type="text" required="" class="col-sm-8 form-control modefieldcls" oninvalid="this.setCustomValidity('Select the Call Type')" oninput="this.setCustomValidity('')" style="border-radius:5px;" id="calltype" name="calltype" placeholder="Enter group name" autocomplete="off">
...
<div class="form-group form-inline">
                     ...
                     <!-- <label class="col-sm-2" style="/* text-align:center */" for="exampleInputPassword1"></label> -->
    <label class="col-sm-4"  for="exampleInputPassword1">Call Status<span style="color:red;">*</span> </label>
  ...
  <textarea name="display" id="display" class="col-sm-8 form-control prodinterestselectcls" style="border-radius:15px;" placeholder="
  <?php 
...
<div class="row">
  <div class="col-sm-6">
    ...
    <div class="form-group form-inline">
                     ...
                     <!-- <label class="col-sm-2" style="/* text-align:center */" for="exampleInputPassword1"></label> -->
    <label class="col-sm-4"  for="exampleInputPassword1">Next Date</label>
	...
	<?php if($calllog_data1):?>
				...
				<?php // echo strftime('%Y-%m-%d',  strtotime($v1['Follow_Up_Date'])) ?>
				  <input type="date" class="col-sm-8 form-control modefieldcls" style="border-radius:5px;"  id="Follow_Up_Date" name="Follow_Up_Date" 
  ...
  <div class="form-group form-inline">
                     ...
                     <!-- <label class="col-sm-2" style="/* text-align:center */" for="exampleInputPassword1"></label> -->
    <label class="col-sm-4"  for="exampleInputPassword1">Notes</label>
	...
	<?php if($calllog_data1):?>
				 ...
				 <textarea class="form-control col-sm-8 prodinterestselectcls nxtdate" style='height:130px;border-radius:30px;' rows="4" cols="100" name="Notes" id="Notes" ><?php echo $v1['Notes']?></textarea>
...
<div class="modal" id="userModal2" >
    ...
    <input class="col-sm-6" oninvalid="this.setCustomValidity('Enter the City')" oninput="this.setCustomValidity('')"   style="border-radius:5px;height:30px" type="text" class="form-control contentPicker input-xxlarge ui-autocomplete-input valid" id="city_name_grp" name="city_name_grp" required placeholder="">
  </div> 
