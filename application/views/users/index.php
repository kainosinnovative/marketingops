...
/**.content-header>h1 {
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <div class="row-sm-12" style="text-align:right;">
   <?php if(in_array('createUser', $user_permission)): ?>
            <a href="<?php echo base_url('users/create') ?>"><i class="fa fa-plus" ></i> <u>Add Customer</u></a>
            <br /> <br />
          <?php endif; ?>
   </div>
    </section>
...
<?php echo validation_errors(); ?>
          ...
          <div class="box ">
            ...
            <div class="box-body table-responsive" >
			 ...
			 foreach ($city_data as $k4 => $v4):
                        ...
                        if($v['user_info']['Landline_Number'] == 0) {
                            
                        }
                        else {
                        echo $v['user_info']['Landline_Number']; 
                        } ?></td>
	...
	<div class="row">
        ...
        <div class="col-sm-4">
                <div class="form-group form-inline">
                          ...
                          <input type="text" class="col-sm-8 form-control heightfieldcls" required="" maxlength="355" oninvalid="this.setCustomValidity('Enter the Customer Name')" oninput="this.setCustomValidity('')" style="border-radius:5px;height:35px;" id="customername" name="customername" value="<?php echo $cusname ?>"  >
                  </div>
          </div>
              ...
              <div class="form-group form-inline">
                        ...
                        <?php
							if($activerecord=="1")
				{
				echo '<input class="col-sm-8" type="checkbox" name="active" id="active" checked>';
				}
				else
				{
					echo '<input class="col-sm-8" type="checkbox" name="active" id="active" >';
				}?>
   ...
   <div class="col-md-4" >
          <div class="form-group form-inline">
              ...
              <input type="email"  class="col-sm-8 form-control heightfieldcls1" pattern="[^@\s]+@[^@\s]+\.[^@\s]+" required="" oninvalid="this.setCustomValidity('Enter the Email id')" oninput="this.setCustomValidity('')" style="border-radius:5px;height:35px;" id="email" name="email" value="<?php echo $email?>">
          </div>
          <p class="offclick"></p>
          ...
          <label for="phone" class="col-sm-4" style="color:#0c0c0c;">Landline #</label> 
				  ...
				  <input type="number" class="col-sm-8 form-control heightfieldcls2" style="height:35px;border-radius:5px;" id="phone" name="phone"  value="
				  <?php  
		        if($landline == 0) {
          ...
          <label for="phone"  class="col-sm-4" style="color:#0c0c0c;">Mobile #<span style="color:red;"> *</span></label>
			    ...
			    <input type="text" class="col-sm-8 form-control heightfieldcls2" pattern="[0-9]{10}" required="" oninvalid="this.setCustomValidity('Enter the Mobile Number')" oninput="this.setCustomValidity('')" class="form-control" style="border-radius:5px;" id="mphone" name="mphone" maxlength="10" value="<?php echo $mobile?>">
          </div> 
        </div>
        ...
        <div class="col-md-4">
          <div class="form-group form-inline">
                  ...
                  <input type="text"  required="" class="col-sm-8 form-control heightfieldcls" oninvalid="this.setCustomValidity('Enter the Street')" oninput="this.setCustomValidity('')" style="border-radius:5px;height:35px;width:65%;" id="address1" name="address1" value="<?php echo $addresss?>">
  ...
  <p class="offlick" ></p>
	...
	<div class="row" >
      <div class="col-md-4" >
          <div class="form-group form-inline">
            ...
            <label for="email" class="col-md-4" style="color:#0c0c0c;">Fax</label>
		        ...
		        <input type="number" class="col-md-8 form-control heightfieldcls2" value="<?php  
		        if($faxnumber == 0) {
		            
		        }
		        else {
		        echo $faxnumber;
		        } ?>" style="border-radius:5px;" id="fax" name="fax" >
      ...
      <div class="col-md-4" >
          <div class="form-group form-inline">
                ...
                <input type="text" required="" class="col-md-8 form-control heightfieldcls2" oninvalid="this.setCustomValidity('Enter the Pincode')" oninput="this.setCustomValidity('')" style="border-radius:5px;" id="pincode" maxlength="6" pattern="[0-9]{6}" name="pincode" value="<?php echo $pincode?>">
		      </div>
      </div>
   ...
   <div  id="savebut" class="modal-footer" >
...
<div id="localityModal" class="modal fade">  
      <div class="modal-dialog "   >  
           <form method="post" id="locality_form"  >  
                <div class="modal-content" style="margin-top: 169px !important;width: 324px !important;">  
                     <div class="modal-header" style="text-align:center">  
