...
<div class="col-sm-5">
          ...
          <form  action="<?php base_url('ProductInterestController/savedata') ?>" method="post" enctype="multipart/form-data">
...
<div class="col-sm-12"> 
<input class="col-sm-12" name="category_name" required style="border-radius:5px;height:30px" oninvalid="this.setCustomValidity('Enter Product Category')" oninput="this.setCustomValidity('')" type="text" class="form-control">
</div>
...
<!-- <div class="row" style="    margin-top: 10px;">  -->
<div class="col-sm-12"> 
<select class="form-control" id="productcategory_id" name="productcategory_id" style="border-radius:5px;height:30px">
...
<input class="col-sm-12" style="border-radius:5px;height:30px" name="product_name" oninvalid="this.setCustomValidity('Enter the city')" oninput="this.setCustomValidity('')" type="text" class="form-control">
</div>
