...
$this->data['newContactlist'] = $this->model_users->getNewcontactlist1($fromdate,$todate);
	...
	else
	{
	   // echo "uu";
	   // echo $customername;
	    $this->data['calllog_data']=$this->model_groups->getCallLogdataByCusId($fromdate,$todate,$customername);
		$this->data['total_person'] = $this->model_groups->countTotalPersonByCusId($fromdate,$todate,$customername);
		$this->data['total_phone'] = $this->model_groups->countTotalPhoneByCusId($fromdate,$todate,$customername);
		$this->data['total_cold'] = $this->model_groups->countTotalColdByCusId($fromdate,$todate,$customername);
		$this->data['total_warm'] = $this->model_groups->countTotalWarmByCusId($fromdate,$todate,$customername);
        $this->data['total_hot'] = $this->model_groups->countTotalHotByCusId($fromdate,$todate,$customername);
		$this->data['total_customers'] = $this->model_users->countTotalUsersByCusId($fromdate,$todate,$customername);
		$this->data['total_new'] = $this->model_users->countTotalNewCustomersByCusId($fromdate,$todate,$customername);
		$this->data['total_contact']=$this->model_users->countTotalContactByCusId($fromdate,$todate,$customername);
		$this->data['total_newcontact']=$this->model_users->countTotalNewContactByCusId($fromdate,$todate,$customername);
		 $this->data['newuserlist'] = $this->model_users->getNewuserlistByCusId1($fromdate,$todate,$customername);
	   
	   $this->data['newContactlist'] = $this->model_users->getNewcontactlistByCusId1($fromdate,$todate,$customername);
	}
...
//print_r($this->data);
$this->data['customer_list']=$this->model_users->getUserData();
