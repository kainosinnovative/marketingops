...
<div class="col-sm-12"> 
<input class="col-sm-12" name="category_name" id="category_name" required style="border-radius:5px;height:30px" oninvalid="this.setCustomValidity('Enter Product Category')" oninput="this.setCustomValidity('')" type="text" class="form-control">
</div>
...
<input type="submit" name="save1" class="btn btn-primary" value="Save" />
        </div>
</div>
...
<!-- <div class="row" style="    margin-top: 10px;">  -->
<div class="col-sm-12"> 
<select class="form-control" required = "" oninvalid="this.setCustomValidity('select Product Category')" oninput="this.setCustomValidity('')"  id="productcategory_id" name="productcategory_id" style="border-radius:5px;height:30px">
...
<input class="col-sm-12" required style="border-radius:5px;height:30px" oninvalid="this.setCustomValidity('Enter Product Name')" oninput="this.setCustomValidity('')" name="product_name" id="product_name" oninvalid="this.setCustomValidity('Enter the city')" oninput="this.setCustomValidity('')" type="text" class="form-control">
</div>
